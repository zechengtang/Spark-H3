...
def _frontiers_for_layout(video_tokens, children, grid_shape,
...
def virtual_query_layout(video_tokens,total_tokens,levels_up,children=(8,4),*,grid_shape=None,
                         fanout_mode='power_of_two_fanout',hierarchy=None):
    ...
    leaves=video_tokens//64;levels,hierarchy_metadata,children=_frontiers_for_layout(video_tokens,children,grid_shape,fanout_mode,hierarchy)
...
def target_virtual_query_layout(video_tokens,total_tokens,target_blocks=SPARK_REWEIGHT_TARGET_BLOCKS,min_blocks=SPARK_REWEIGHT_MIN_BLOCKS,max_blocks=SPARK_REWEIGHT_MAX_BLOCKS,children=(8,4),*,grid_shape=None,fanout_mode='power_of_two_fanout',hierarchy=None):
