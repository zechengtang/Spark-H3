# Source experiment snapshots

These reports and metric files are copied unchanged from MiniMax-H3-Sparse to
support the blog's historical claims. `../PORT_MANIFEST.json` records original
paths, the source commit, and SHA-256 hashes. The source working tree can include
changes beyond that commit; file hashes identify the copied content.
